(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-oppurtunity-details-oppurtunity-details-module"], {
    ...
    /***/
    function srcAppPagesOppurtunityDetailsOppurtunityDetailsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OppurtunityDetailsRoutingModule", function () {
        return OppurtunityDetailsRoutingModule;
      });
      /* harmony import */
      ...
      var _oppurtunity_details_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./oppurtunity-details.component */
      ...
      var OppurtunityDetailsRoutingModule = /*#__PURE__*/_createClass(function OppurtunityDetailsRoutingModule() {
        _classCallCheck(this, OppurtunityDetailsRoutingModule);
      });

      OppurtunityDetailsRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: OppurtunityDetailsRoutingModule
      });
      OppurtunityDetailsRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function OppurtunityDetailsRoutingModule_Factory(t) {
          return new (t || OppurtunityDetailsRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](OppurtunityDetailsRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OppurtunityDetailsRoutingModule, [{
    ...
    /***/
    function srcAppPagesOppurtunityDetailsOppurtunityDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OppurtunityDetailsComponent", function () {
        return OppurtunityDetailsComponent;
      });
      /* harmony import */
      ...
      function OppurtunityDetailsComponent_div_16_div_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function OppurtunityDetailsComponent_div_16_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function OppurtunityDetailsComponent_button_20_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function OppurtunityDetailsComponent_p_26_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var OppurtunityDetailsComponent = /*#__PURE__*/function () {
        function OppurtunityDetailsComponent(_location, route, pageService) {
          _classCallCheck(this, OppurtunityDetailsComponent);
        ...
        _createClass(OppurtunityDetailsComponent, [{
          key: "ngOnInit",
      ...
      OppurtunityDetailsComponent.ɵfac = function OppurtunityDetailsComponent_Factory(t) {
        return new (t || OppurtunityDetailsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_1__["Location"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_service_pages_service__WEBPACK_IMPORTED_MODULE_3__["PagesService"]));
      };

      OppurtunityDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: OppurtunityDetailsComponent,
        selectors: [["app-oppurtunity-details"]],
        decls: 44,
        vars: 6,
        consts: [[1, "oppurtunity", "pt-60", "pb-60"], [1, "container"], [1, "row", "mt--30"], [1, "col-lg-8", "mt-30"], [1, "left-box"], [1, "fs-2"], ["href", "#", 1, "text-decoration-none", 2, "color", "#00A3FF", "font-size", "14px"], [1, "fs-3", "mt-3", 2, "font-weight", "600"], [2, "text-align", "justify", 3, "innerHTML"], ["class", "mt-3", 4, "ngIf"], [1, "col-lg-4", "col-md-7", "mt-30"], [1, "bg-white", "rounded-3", "px-5", "py-4", "shadow-sm"], [1, "d-grid", "gap-2"], ["class", "btn btn-primary", "type", "button", 3, "routerLink", 4, "ngIf"], ["type", "button", 1, "btn", "btn-outline-primary", "mt-3"], [2, "text-align", "left", "display", "inline-block"], [1, "bi", "bi-share-fill", "ms-5"], [1, "mt-3"], ["class", "fs-4 fw-bold text-dark", 4, "ngIf"], [1, "lh-1", "text-dark", "fw-bold", "mt-3"], [1, ""], [1, "fs-4"], ["id", "image-gallery"], [1, "row", "g-3", "mt-1"], ["class", "col-lg-3 col-md-4 col-6", 4, "ngFor", "ngForOf"], [1, "col-lg-3", "col-md-4", "col-6"], ["alt", "Image", 1, "img-fluid", "rounded-1", 3, "src"], ["type", "button", 1, "btn", "btn-primary", 3, "routerLink"], [1, "bi", "bi-envelope-fill", "me-3"], [1, "fs-4", "fw-bold", "text-dark"]],
        template: function OppurtunityDetailsComponent_Template(rf, ctx) {
          if (rf & 1) {
        ...
        directives: [_includes_header_header_component__WEBPACK_IMPORTED_MODULE_4__["HeaderComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["NgIf"], _includes_footer_footer_component__WEBPACK_IMPORTED_MODULE_5__["FooterComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["NgForOf"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterLink"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OppurtunityDetailsComponent, [{
    ...
    /***/
    function srcAppPagesOppurtunityDetailsOppurtunityDetailsModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OppurtunityDetailsModule", function () {
        return OppurtunityDetailsModule;
      });
      /* harmony import */
      ...
      var _oppurtunity_details_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./oppurtunity-details-routing.module */
      "./src/app/pages/oppurtunity-details/oppurtunity-details-routing.module.ts");
      /* harmony import */


      var _oppurtunity_details_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./oppurtunity-details.component */
      "./src/app/pages/oppurtunity-details/oppurtunity-details.component.ts");
      /* harmony import */
      ...
      var OppurtunityDetailsModule = /*#__PURE__*/_createClass(function OppurtunityDetailsModule() {
        _classCallCheck(this, OppurtunityDetailsModule);
      });

      OppurtunityDetailsModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: OppurtunityDetailsModule
      });
      OppurtunityDetailsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function OppurtunityDetailsModule_Factory(t) {
          return new (t || OppurtunityDetailsModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _oppurtunity_details_routing_module__WEBPACK_IMPORTED_MODULE_2__["OppurtunityDetailsRoutingModule"], src_app_includes_include_module__WEBPACK_IMPORTED_MODULE_4__["IncludeModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](OppurtunityDetailsModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OppurtunityDetailsModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
            declarations: [_oppurtunity_details_component__WEBPACK_IMPORTED_MODULE_3__["OppurtunityDetailsComponent"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _oppurtunity_details_routing_module__WEBPACK_IMPORTED_MODULE_2__["OppurtunityDetailsRoutingModule"], src_app_includes_include_module__WEBPACK_IMPORTED_MODULE_4__["IncludeModule"]]
...
//# sourceMappingURL=pages-oppurtunity-details-oppurtunity-details-module-es5.js.map