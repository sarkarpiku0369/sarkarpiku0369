...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomValidatos", function() { return CustomValidatos; });
class CustomValidatos {
...
/* harmony import */ var src_app_helpers_must_match_validator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/_helpers/must-match.validator */ "./src/app/_helpers/must-match.validator.ts");
/* harmony import */ var src_app_helpers_custom_validator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/_helpers/custom-validator */ "./src/app/_helpers/custom-validator.ts");
...
function NotificationComponent_div_29_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "First name is required");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function NotificationComponent_div_29_Template(rf, ctx) { if (rf & 1) {
...
function NotificationComponent_div_35_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Last name is required");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function NotificationComponent_div_35_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 64);
...
function NotificationComponent_div_54_Template(rf, ctx) { if (rf & 1) {
...
function NotificationComponent_div_60_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 66);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "small", 67);
...
function NotificationComponent_div_66_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 66);
...
function NotificationComponent_div_67_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 66);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "small", 68);
...
class NotificationComponent {
    constructor(userService, router, toastr, formBuilder) {
    ...
    ngOnInit() {
        ...
        this.changePassForm = this.formBuilder.group({
            ...
            password: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([
                    ...
                    src_app_helpers_custom_validator__WEBPACK_IMPORTED_MODULE_3__["CustomValidatos"].patternValidator(/\d/, { hasNumber: true }),
                    src_app_helpers_custom_validator__WEBPACK_IMPORTED_MODULE_3__["CustomValidatos"].patternValidator(/[A-Z]/, { hasCapitalCase: true }),
                    src_app_helpers_custom_validator__WEBPACK_IMPORTED_MODULE_3__["CustomValidatos"].patternValidator(/[a-z]/, { hasSmallCase: true }),
    ...
    saveProfile() {
        ...
        if (this.profileSecOne.invalid) {
            ...
            this.userService.updateProfile(token, formData).subscribe((res) => {
                console.log(res);
                if (res.status) {
    ...
    changePasswordSubmit() {
        ...
        if (this.changePassForm.invalid) {
            ...
            this.userService.changePassword(token, formData).subscribe((res) => {
                console.log(res);
                if (res.status) {
                    this.toastr.success(res.message);
                    this.changePassSubmitted = false;
...
NotificationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NotificationComponent, selectors: [["app-notification"]], decls: 163, vars: 30, consts: [[1, "account-page", "pt-120", "pb-120"], [1, "container"], [1, "row", "mt--30"], [1, "col-lg-4"], ["id", "pills-tab", "role", "tablist", 1, "nav", "nav-pills", "mt-30"], ["role", "presentation", 1, "nav-item"], ["id", "pills-account-tab", "data-bs-toggle", "pill", "data-bs-target", "#pills-account", "type", "button", "role", "tab", "aria-controls", "pills-account", "aria-selected", "true", 1, "nav-link", "active"], ["id", "pills-password-tab", "data-bs-toggle", "pill", "data-bs-target", "#pills-password", "type", "button", "role", "tab", "aria-controls", "pills-password", "aria-selected", "false", 1, "nav-link"], ["id", "pills-notification-tab", "data-bs-toggle", "pill", "data-bs-target", "#pills-notification", "type", "button", "role", "tab", "aria-controls", "pills-notification", "aria-selected", "false", 1, "nav-link"], ["id", "pills-delete-tab", "data-bs-toggle", "pill", "data-bs-target", "#pills-delete", "type", "button", "role", "tab", "aria-controls", "pills-delete", "aria-selected", "false", 1, "nav-link"], [1, "col-xl-6", "col-lg-8", "mt-30"], ["id", "pills-tabContent", 1, "tab-content"], ["id", "pills-account", "role", "tabpanel", "aria-labelledby", "pills-account-tab", 1, "tab-pane", "fade", "show", "active"], [1, "account-input-box"], [3, "formGroup"], [1, "row"], [1, "col-lg-6"], [1, "form-group", "position-relative"], [1, "icon"], [1, "icofont-user-alt-7"], ["type", "text", "placeholder", "First Name", "formControlName", "fname", 1, "form-control", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], ["type", "text", "placeholder", "Last name", "formControlName", "lname", 1, "form-control", 3, "ngClass"], [1, "col-lg-12"], [1, "icofont-envelope"], ["type", "email", "readonly", "readonly", "placeholder", "Email", "formControlName", "email", 1, "form-control"], [1, "co-12"], [1, "button-group", "d-md-flex", "justify-content-md-end"], [1, "button1", 3, "click"], ["id", "pills-password", "role", "tabpanel", "aria-labelledby", "pills-password-tab", 1, "tab-pane", "fade"], [3, "formGroup", "ngSubmit"], [1, "col-12"], [1, "icofont-ui-password"], ["type", "password", "formControlName", "old_password", "placeholder", "Old Password", 1, "form-control"], ["class", "error-disp", 4, "ngIf"], ["type", "password", "formControlName", "password", "placeholder", "New password", 1, "form-control"], ["type", "password", "formControlName", "password_confirmation", "placeholder", "Confirm new password ", 1, "form-control"], [1, "password-info", "mt-30"], [1, "col", 3, "ngClass"], ["aria-hidden", "true"], [1, "col", "mb-3", 3, "ngClass"], [1, "button1", "pass"], ["id", "pills-notification", "role", "tabpanel", "aria-labelledby", "pills-notification-tab", 1, "tab-pane", "fade"], [1, "col-md-12"], [1, "list-group", "notificationBox"], [1, "list-group-item", "d-flex", "justify-content-between", "align-items-start"], [1, "ms-2", "me-auto"], [1, ""], [1, "mb-3"], [1, "form-check", "form-switch"], ["type", "checkbox", "id", "flexSwitchCheckDefault", 1, "form-check-input", "mt-5", "mt-md-5"], ["type", "checkbox", "id", "flexSwitchCheckDefault", 1, "form-check-input"], [1, "btn", "btn-outline-warning"], ["id", "pills-delete", "role", "tabpanel", "aria-labelledby", "pills-delete-tab", 1, "tab-pane", "fade"], [1, "delet-account-box"], ["href", "#0"], [1, "form-floating"], ["placeholder", "Leave a comment here", "id", "floatingTextarea2", 1, "form-control", 2, "height", "100px"], ["for", "floatingTextarea2"], [1, "mb-2", "mt-2", "form-check"], ["type", "checkbox", "id", "exampleCheck1", 1, "form-check-input"], ["for", "exampleCheck1", 1, "form-check-label"], [1, "button1"], [1, "button2"], [1, "invalid-feedback"], [4, "ngIf"], [1, "error-disp"], [1, "text-danger", "danger-custom"], [1, "text-danger", "danger-custom", "signin-email"]], template: function NotificationComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NotificationComponent_Template_button_click_43_listener() { return ctx.saveProfile(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function NotificationComponent_Template_form_ngSubmit_47_listener() { return ctx.changePasswordSubmit(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NotificationComponent, [{
    ...
    }], function () { return [{ type: src_app_service_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }, { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }]; }, null); })();
...
/* harmony import */ var _notification_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./notification-routing.module */ "./src/app/pages/notification/notification-routing.module.ts");
...
NotificationModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function NotificationModule_Factory(t) { return new (t || NotificationModule)(); }, imports: [[
            ...
            _notification_routing_module__WEBPACK_IMPORTED_MODULE_2__["NotificationRoutingModule"],
            src_app_includes_include_module__WEBPACK_IMPORTED_MODULE_4__["IncludeModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NotificationModule, { declarations: [_notification_component__WEBPACK_IMPORTED_MODULE_3__["NotificationComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"],
        _notification_routing_module__WEBPACK_IMPORTED_MODULE_2__["NotificationRoutingModule"],
        src_app_includes_include_module__WEBPACK_IMPORTED_MODULE_4__["IncludeModule"]] }); })();
