...
class LoginComponent {
    constructor(page, router, toastr, spinner, userService, formBuilder) {
        this.page = page;
        this.router = router;
        this.toastr = toastr;
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 47, vars: 13, consts: [[1, "homefix_login_area", "pt-85", "pb-120"], [1, "container"], [1, "row", "justify-content-center"], [1, "col-xl-6", "col-lg-8"], [1, "homefix_login_inner"], [1, "homefix_login_details"], [1, "form_title"], [1, "login_form_title"], [3, "formGroup", "ngSubmit"], ["href", "#", 1, "login_facebook_btn"], ["src", "assets/images/facebook.png", "alt", "facebook"], ["href", "#", 1, "login_google_btn"], ["src", "assets/images/email.png", "alt", "email"], [1, "or_cont"], [1, "login_from_field"], [1, "login_from_field_inner"], [1, "icofont-envelope"], ["type", "email", "placeholder", "Email Address", "formControlName", "email", "name", "email", "id", "loginemail", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], [1, "icofont-key"], ["type", "password", "name", "password", "formControlName", "password", "value", "", "placeholder", "Password", 3, "ngClass"], ["type", "submit", "value", "Continue"], [1, "input_checked"], ["id", "checked", "type", "checkbox"], ["for", "checked"], [1, "forgot_pass"], [3, "routerLink"], [1, "remember"], ["for", ""], [1, "invalid-feedback"], [4, "ngIf"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function LoginComponent_Template_form_ngSubmit_10_listener() { return ctx.loginSubmit(); });
